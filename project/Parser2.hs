...
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","Var","label","\":\"","tab","jump","comment","NextArg","if","elif","else","Choice","or","Index","and","\"(\"","Dollar","VarDefine","var","num","bool","text","Symbol","List","TitleShow","play","\")\"","show","loop","onlayer","voice","menu","Extend","Bg","Pos","%eof"]
...
happyNewToken action sts stk (tk:tks) =
	...
	Lexer.Tab -> cont 7;
	Lexer.Jump -> cont 8;
	Lexer.PythonComment -> cont 9;
	Lexer.NextArg -> cont 10;
	Lexer.Cond Lexer.If -> cont 11;
	Lexer.Cond Lexer.Elif -> cont 12;
	Lexer.Cond Lexer.Else -> cont 13;
	Lexer.Choice happy_dollar_dollar -> cont 14;
	Lexer.BoolOr -> cont 15;
	Lexer.Index happy_dollar_dollar -> cont 16;
	Lexer.BoolAnd -> cont 17;
	Lexer.OpenParen -> cont 18;
	Lexer.Dollar -> cont 19;
	Lexer.VarDefine -> cont 20;
	Lexer.Var happy_dollar_dollar -> cont 21;
	Lexer.Num happy_dollar_dollar -> cont 22;
	Lexer.Bool happy_dollar_dollar -> cont 23;
	Lexer.Text happy_dollar_dollar -> cont 24;
	Lexer.Symbol happy_dollar_dollar -> cont 25;
	Lexer.List happy_dollar_dollar -> cont 26;
	Lexer.TitleShow -> cont 27;
	Lexer.Play -> cont 28;
	Lexer.CloseParen -> cont 29;
	Lexer.Show -> cont 30;
	Lexer.LoopAudio -> cont 31;
	Lexer.Layer -> cont 32;
	Lexer.VoiceLine -> cont 33;
	Lexer.Menu -> cont 34;
	Lexer.Extend -> cont 35;
	Lexer.Bg -> cont 36;
	Lexer.Pos -> cont 37;
	_ -> happyError' ((tk:tks), [])
	}
